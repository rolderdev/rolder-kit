...
const {
    ...
    widthString, noHeader, selectable, selectableType, highlightOnHover, highlightSelectedRow, className, enableHeader, headerHeight, enableFooter,
...
const groupedProps = {
    ...
    Table: {
        className, tableData, isLoading, columns, shadow, fontSize, borderRadius, verticalSpacing, withBorder, withColumnBorders, widthString, minHeight,
