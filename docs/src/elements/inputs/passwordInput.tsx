...
import { ActionIcon, Button, Code, Divider, Group, Stack, Text } from '@mantine/core'
import sizes from '../../configurator/params/sizes'
import { IconClearAll, IconClearFormatting, IconEraser, IconRestore, IconTractor, IconTrashOff, IconTrashX } from '@tabler/icons-react'
