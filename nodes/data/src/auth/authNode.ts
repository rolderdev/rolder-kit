...
export default reactNode('Auth', {
    'v0.1.0': {
        ...
        inputs: [
            getPort({
                plug: 'input', name: 'sessionTimeout', displayName: 'Session timeout', group: 'Params', type: 'string', default: '5d',
                customs: {
                    required: 'both',
                    validate(p) {
            ...
            getPort({
                plug: 'input', name: 'username', displayName: 'Username', group: 'Params', type: getType('string', 'connection')
            }),
            getPort({
                plug: 'input', name: 'password', displayName: 'Password', group: 'Params', type: getType('string', 'connection')
            }),
