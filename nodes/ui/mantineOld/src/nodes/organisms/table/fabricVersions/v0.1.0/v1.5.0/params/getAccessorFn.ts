...
export default function (columnDef: ColumnDef, row: RItem) {
    ...
    switch (columnDef.data?.type) {
        ...
        case 'mask': return getMasked.v2(
            ...
            getValue.v8(row, columnDef.accessor, columnDef.data.default, columnDef.data.defaultAccessor)
        )
        case 'number': return numbro(getValue.v8(row, columnDef.accessor, columnDef.data.default, columnDef.data.defaultAccessor) || 0)
        ...
        default: return getValue.v8(row, columnDef.accessor, columnDef.data?.default, columnDef.data?.defaultAccessor)
    }
}