...
// =====================================================
import libs from './libs'; R.libs = libs
import utils from './utils'; R.utils = utils
import * as icons from './icons'; R.libs.icons = icons
...
Noodl.defineModule({
    ...
    }, { allowChildren: true, docs: 'https://docs.rolder.app/docs/project/App.html' })],
    settings: [
