...
import { enums } from "../v0.2.0/enums"
...
/*     { name: 'useForm', group: 'Form', type: 'boolean', displayName: 'Use form' },
   ...
   /*  { name: 'columns', group: 'Params', type: 'array', displayName: 'Columns' },
    ...
    { name: 'singleSelect', group: 'Params', type: 'boolean', displayName: 'Single select', default: false, dependsOn: { name: 'selectable', value: true } },
    { name: 'singleUnselectable', group: 'Params', type: 'boolean', displayName: 'Single unselectable', default: false, dependsOn: { name: 'singleSelect', value: true } },
    { name: 'multiSelect', group: 'Params', type: 'boolean', displayName: 'Multi select', default: false, dependsOn: { name: 'selectable', value: true } },
    { name: 'allSelect', group: 'Params', type: 'boolean', displayName: 'All select', default: true, dependsOn: { name: 'multiSelect', value: true } },
    ...
    { name: 'expandAllAction', group: 'Params', type: 'boolean', displayName: 'Expand all', default: true, dependsOn: { name: 'grouped', value: true } },
    { name: 'drawerHeaderEnabled', group: 'Params', type: 'boolean', displayName: 'Header', default: false },
    { name: 'closeActionEnabled', group: 'Params', type: 'boolean', displayName: 'Enable close action', default: false, dependsOn: { name: 'drawerHeaderEnabled', value: true } },
    ...
    { name: 'textMask', group: 'Params', type: 'string', displayName: 'Mask', default: '{8} (000) 000-00-00', tooltip: "IMask js lib mask", dependsOn: { name: 'masked', value: true } },
    ...
    { name: 'query', group: 'Params', type: 'array', displayName: 'Query', isObject: true, dependsOn: { name: 'queryType', value: 'fetch' }, tooltip: "Example: [{ equals: { 'content.firstName': 'Родион' } }]" },
    { name: 'sort', group: 'Params', type: 'array', displayName: 'Sort', dependsOn: { name: 'queryType', value: 'fetch' }, tooltip: "Example: [{ content.lastName: 'asc' }, { content.firstName: 'asc' }]" },
   ...
   /*  { name: 'margins', group: 'Margins', type: 'boolean', displayName: 'Margins' },
    ...
    // Font    
   /*  { name: 'drawerTitleOrder', group: 'Font', type: 'number', displayName: 'Order', tooltip: '1 - 6', dependsOn: { name: 'drawerHeaderEnabled', value: true }, default: 4 },
   ...
   /*  { name: 'color', group: 'Style', type: 'string', displayName: 'Color', tooltip: 'red, red.5' },
    ...
    { name: 'onHoverColor', group: 'Style', type: 'string', displayName: 'On hover color', tooltip: 'red, red.5', dependsOn: { name: 'highlightOnHover', value: true } },
    { name: 'selectedColor', group: 'Style', type: 'string', displayName: 'Selected color', tooltip: 'red, red.5', dependsOn: { name: 'highlightSelected', value: true } },
    { name: 'multiSelectCheckboxColor', group: 'Style', type: 'string', displayName: 'Checkbox color', tooltip: 'red, red.5', dependsOn: { name: 'multiSelect', value: true } },
    ...
    { name: 'highlightSelected', group: 'Params', type: 'boolean', displayName: 'Hightlight selected', default: false, dependsOn: { name: 'singleSelect', value: true } },
