...
## 2024-08-01 v1.0.0-rc3

### data

#### UseData v1.4.0 `#experimental`

Добавлена версия API. Версия API - это версия контроллера на сервере Kuzzle. Сделано, чтобы можно было менять схему UseData с поддержкой обратной совместимости.
...
- Сортировка.
- Отступ.
- Поправлен баг - не завершалась анимация загрузки, если подать пустой массив items.
- Поправлен баг - не устанавливался цвет строки.

#### TableScope v2.0.0 `#experimental`
