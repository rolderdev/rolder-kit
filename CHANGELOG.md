...
- dropZone v1.1.0 - теперь можно подавать несколько типов файлов.
- text v1.0.2 - пофиксил: не работал перенос на новую строку "\n".
- dropZone v1.1.1 - увеличил размер принимаемого файла до 20 Мб.

### data
- updateByQuery v1.0.0 - поправил вывод ошибки. В тексте было "update", изменил на "updateByQuery".
- nodered v1.3.0 - добавлен сервис copyDBClass.

### xlsx
- createXlsx v1.1.0 - добавлена возможность редактирвать выравнивание и переност текста.
