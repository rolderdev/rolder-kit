...
* Инструкции:
  ...
  * Кастомная ячейка:
    ...
    * Вставить в ColumnCell Repeater и подать в него теже items, что и в таблицу. Таблица будет искать ColumnCell с соответсвующим item и отрисовывать ее в нужной ячейкею.
