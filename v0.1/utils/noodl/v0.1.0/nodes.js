...
import UseData_v0_2_0 from "../../../react-nodes/data/UseData/UseData_v0.2.0"
...
import Drawer_v0_1_1 from "../../../react-nodes/molecules/Drawer/Drawer_v0.1.1"
...
import Stack_v0_1_1 from "../../../react-nodes/molecules/Stack/Stack_v0.1.1"
import Carousel_v0_1_0 from "../../../react-nodes/molecules/Carousel/Carousel_v0.1.0"
import Box_v0_1_0 from "../../../react-nodes/molecules/Box/Box_v0.1.0"
///////////
// elements
// buttons
import ActionIcon_v0_1_0 from "../../../react-nodes/elements/buttons/ActionIcon/ActionIcon_v0.1.0"
import ActionIcon_v0_1_1 from "../../../react-nodes/elements/buttons/ActionIcon/ActionIcon_v0.1.1"
...
import Text_v0_2_2 from '../../../react-nodes/elements/typography/Text/Text_v0.2.2'
...
const reactNodes = {
    ...
    UseData: { portsToCheck: ['dbClass'], versions: { '0.2.0': UseData_v0_2_0, } },
    ...
    Table: { portsToCheck: ['columns'], versions: { '0.1.0': Table_v0_1_0, '0.2.0': Table_v0_2_0, } },
    ...
    Drawer: { allowChildren: true, versions: { '0.1.1': Drawer_v0_1_1, } },
    ...
    Stack: { allowChildren: true, versions: { '0.1.1': Stack_v0_1_1, } },
    Carousel: { allowChildren: true, versions: { '0.1.0': Carousel_v0_1_0, } },
    Box: { allowChildren: true, versions: { '0.1.0': Box_v0_1_0, } },
    ///////////
    // elements
    // buttons
    actionIcon: { versions: { '0.1.0': ActionIcon_v0_1_0, } },
    ActionIcon: { versions: { '0.1.1': ActionIcon_v0_1_1, } },
    ...
    Text: { versions: { '0.2.2': Text_v0_2_2, } },
}
...
const nodes = {
    ...
    createUser: {
        name: 'createUser',
        portsDefinition: (v) => v && portsDefinition('createUser', v),
        nodeImport: async (v) => v && import('../../../nodes/data/createUser/createUser' + '_v' + v),
        versions: ['0.1.0'],
    },
    create: {
        name: 'create',
