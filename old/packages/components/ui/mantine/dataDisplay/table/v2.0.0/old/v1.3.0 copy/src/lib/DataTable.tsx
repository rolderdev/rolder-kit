...
export default function DataTable<T>({
	...
	const tableIsIndeterminated = records
		? tableSelectionScopeValue['tableIndeterminatedItemsIdList'].find((indItem) =>
								...
								records.map((record, recordIndex) => {
									...
									const isIndeterminated =
										typeof recordId === 'string'
											? tableSelectionScopeValue['tableIndeterminatedItemsIdList']?.includes(recordId)
											: false
											...
											if ((e.nativeEvent as PointerEvent).shiftKey && lastSelectionChangeIndex !== null) {
												...
												if (isSelected) {
													...
													if (typeof recordId === 'string') {
														...
														if (
															tableSelectionScopeValue['tableIndeterminatedItemsIdList']?.find((itemId) => itemId === recordId)
														) {
