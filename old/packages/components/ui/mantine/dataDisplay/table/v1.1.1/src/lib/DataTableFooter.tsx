import { Box, type CSSObject, type MantineTheme, createStyles } from '@mantine/core'
import { type CSSProperties, ForwardRefExoticComponent, ForwardRefRenderFunction, forwardRef } from 'react'
...
const useStyles = createStyles(
	(theme, { scrollDiff, borderColor }: { scrollDiff: number; borderColor: string | ((theme: MantineTheme) => string) }) => {
