import { Box, type CSSObject, type MantineNumberSize, type MantineTheme, Pagination, Text, createStyles } from '@mantine/core'
...
export default forwardRef(function DataTablePagination(
	...
	return (
		<Box ref={ref} px={horizontalSpacing ?? 'xs'} py="xs" className={cx(classes.root, className)} style={style as CSSProperties}>
