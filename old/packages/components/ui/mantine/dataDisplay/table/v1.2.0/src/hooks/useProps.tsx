...
export default function (props: Props) {
    ...
    // Params    
    const params = {
        customProps: props.customProps, onRowClick: props.table2OnRowClick,
        columnsDef: props.table2Columns || [], items: props.table2Items || []
    }
    // Selection
    const selection = {
    ...
    const libProps = {
        ...
        emptyState: <Text color={props.dataFetchError ? 'red' : 'dimmed'} size="sm">
