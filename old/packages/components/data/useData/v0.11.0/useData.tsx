...
export default forwardRef((props: Props, ref) => {
	...
	return (
		<Box display="none">
			{useDataScheme()?.length &&
				useDataScheme().map((dataScheme) => (
					<Data {...{ noodlNode, useDataScheme: useDataScheme(), dataScheme, searchString: props.searchString }} ref={localRef} />
				))}
		</Box>
	)
})
