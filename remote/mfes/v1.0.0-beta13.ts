...
export default {
  ...
  exposes: {
    ...
    './data/create-v0.4.0': '../shared/components/data/create/v0.4.0/create.ts',
    './data/create-v1.0.0': '../shared/components/data/create/v1.0.0/create.ts',
    './data/update-v0.3.0': '../shared/components/data/update/v0.3.0/update.ts',
    './data/update-v1.0.0': '../shared/components/data/update/v1.0.0/update.ts',
    './data/delete-v0.3.0': '../shared/components/data/delete/v0.3.0/delete.ts',
    './data/delete-v1.0.0': '../shared/components/data/delete/v1.0.0/delete.ts',
    // xlsx ===============================================
