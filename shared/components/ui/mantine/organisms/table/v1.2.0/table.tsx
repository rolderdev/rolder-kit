import { cloneElement, forwardRef, useEffect, useImperativeHandle, useLayoutEffect, useMemo, useState } from 'react';
...
import { tableHandlerAtom, tableSelectionScopeAtom } from "@shared/scope"

// Импортируем созданные нами scope из @shared/scope
import {
    TableFilterScope,
    useTableCellScope,
    useTableFilterScope,
