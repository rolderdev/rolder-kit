...
import { tableSelectionScopeAtom } from '@shared/scope';
...
export default function DataTable<T>({
  ...
  // let { tableSelectionScopeValue, setTableSelectionScopeValue } = useTableSelectionScope()
  const parentTableItemId = tableId ? tableSelectionScopeValue['tableParentItemByTableId'][tableId] : undefined

  const parentTableId = tableId ? tableSelectionScopeValue['parentTableIdByTableId'][tableId] : undefined
