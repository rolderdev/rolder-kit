...
const Comp = forwardRef(function (props: TableCompProps, ref) {
  ...
  useImperativeHandle(ref, () => ({
    ...
    resetSingleSelected() { setSingleSelection('') },
    resetMultipleSelected() { allSelectionHandler(false) },
  }), [items])

  const { table, selectionProps: { setSingleSelection, allSelectionHandler } } = getTabelInstance(props)
