...
import v0_1_0 from './v0.1.0/Data'

const compVersions: CompVersions = {
    'v0.1.0': {
        hashTag: 'experimental',
        Comp: v0_1_0,
        inputs: getPorts('input', ['backendVersion', 'dbName', 'sessionTimeout'], ['backendVersion', 'dbName']),
...
export default getReactNode('Data', compVersions, true)