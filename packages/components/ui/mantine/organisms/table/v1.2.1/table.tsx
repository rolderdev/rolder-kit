...
export default forwardRef(function (props: Props, ref) {
    ...
    // const tableSelectionScopeValue = useAtomValue(tableSelectionScopeAtom)
    // const tableSelectionByDBClassValue = useAtomValue(tableselectionByDBClassAtom)
    // const tableSelectionScopeInternalValue = useAtomValue(tableSelectionScopeInternalAtom)
    // const tableHandlerAtomValue = useAtomValue(tableHandlerAtom)

    // const setTableSelectionScopeValue = useSetAtom(tableSelectionScopeAtom)
    // const setTableSelectionByDBClassValue = useSetAtom(tableselectionByDBClassAtom)
    // const setTableSelectionScopeInternalValue = useSetAtom(tableSelectionScopeInternalAtom)
    // const setTableHandlerAtomValue = useSetAtom(tableHandlerAtom)
