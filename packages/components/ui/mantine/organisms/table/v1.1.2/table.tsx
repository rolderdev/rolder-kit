...
export default forwardRef(function (props: Props, ref) {
        ...
        return columnsDef.map((column, columnIdx) => {
            ...
            if (!filter.enabled) {
                ...
                if (columnFilter) {
                    ...
                    column.filtering = getColumnFilter(columnIdx)?.state !== undefined
                        ? getColumnFilter(columnIdx)?.state
                        : column.filterDefaultEnabled
                }
            }
    ...
    //@ts-ignore
    return tableId ? <ScopeProvider scope={TableScope} value={tableId}><Box w={dimensions.width}><DataTable<Item>
        columns={columns}
