import { MantineColor, MantineNumberSize, MantineShadow } from '@mantine/core';
...
export type Props = BaseReactProps & {
  ...
  // Params
  table2Columns?: ColumnDef[], table2OnRowClick: 'disabled' | 'singleSelection' | 'expansion', table2TextSelection: boolean
  // Data
  table2Items?: Item[]
  tableId?: String  // MD
  parentTableId?: String // MD
  // Single selection
  table2SingleSelectedItem: Item, table2Unselectable: boolean
  // Multi selection
  ...
  // Expansion
  table2ExpandedItems: Item[], table2AllowMultiple: boolean, expansionTemplate: string
  // Layout
  table2NoHeader: boolean
  // Dimensions
  table2Width: MantineNumberSize, table2MinHeight: MantineNumberSize, table2DynamicHeight: boolean, table2Height: MantineNumberSize,
  ...
  // Table styles
  table2Shadow: MantineShadow, table2WithBorder: boolean, table2BorderRadius: MantineNumberSize, table2ColumnBorders: boolean,
...
export type TableProps = {
  libProps: DataTableProps<Item>, children: any, columnsDef: ColumnDef[], items: Item[],
