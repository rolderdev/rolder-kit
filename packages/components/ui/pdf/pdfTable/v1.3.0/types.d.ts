...
export type Column = {
    ...
    headerStyleFunc?(style: { cell?: Styles['string'], text?: Styles['string'] }, items: Item[]): {
        cell?: Styles['string']
        text?: Styles['string']
    }
    cellStyle?: {
    ...
    cellStyleFunc?(style: { cell?: Styles['string'], text?: Styles['string'], image?: Styles['string'] }, item: Item): {
        cell?: Styles['string']
        text?: Styles['string']
        image?: Styles['string']
    }
