...
import { selectGroupedItemAtom } from "./selection/singleGroupedSelection";
...
export default forwardRef(function (props: TableCompProps, ref) {
    ...
    useImperativeHandle(ref, () => ({
        ...
        resetGroupedRowSelection() { selectGroupedItem(props.noodlNode) },
