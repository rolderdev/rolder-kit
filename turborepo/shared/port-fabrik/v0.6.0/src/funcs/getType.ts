...
export function getCustomEnumType(enums: ExpandedType['enums'], only?: 'editor' | 'connection') {
...
export function getEnumType(values: string[], noCase?: boolean, only?: 'editor' | 'connection') {
